...
class Preprocessor:
    ...
    def __init__(self, data_path='data/incar/', vec_dim=300,
        ...
        self.er_dict, self.global_ent, self.eo_dict, self.e_r_l = self.get_kg(self.data_path + 'KG/')
        ...
        for kgf in kg_files:
            ...
            for t in kg:
                ...
                if 'weather' not in kgf:
                    ...
                    eo_pair_dict[e + '#' + o].add(r)
        return er_pair_dict, ent_l, eo_pair_dict, ent_r_l
...
if __name__ == '__main__':
    ...
    if not preproc.args.use_bert:
        preproc_dir = preproc.data_path + 'preproc_files_kg/'
    else:
